...
@Component({
  ...
  styleUrls: ['./mahasangram.component.css']
})
export class MahasangramComponent implements OnInit {
  title = 'ClientApp';
  ...
  getSummaryData() {
    this.isLoading = true;
    this._http.get<IApiResponse<DataResponse>>(this.baseUrl + 'data/mahasangram-summary').subscribe(result => {
      console.log(result);
